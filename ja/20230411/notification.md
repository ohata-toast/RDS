...
* ❻ 활성화 여부를 선택합니다. 활성화 되지 않으면 이벤트 발생 알림을 발송하지 않습니다.
...
> [주의]
> 실명 인증을 하지 않아 휴대폰 정보가 없는 경우 SMS 알림을 받지 못합니다.

### 사용자 그룹 생성

![user_group_01_ja](https://static.toastoven.net/prod_rds/23.04.11/user_group_01_ja.png)
...
* ❷ 알림을 받을 방법을 선택합니다.
* ❸ 활성화 되지 않은 알림 그룹은 알림 발송을 하지 않습니다.
