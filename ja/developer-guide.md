...
> [注意]オブジェクトストレージのバックアップファイルと、復元しようとするMySQLのバージョンは同じである必要があります。
### オブジェクトストレージのバックアップファイルを利用してDBインスタンス作成

* オブジェクトストレージのバックアップファイルを利用して、同じリージョンの他のプロジェクトのRDS for MySQLに復元できます。
* Webコンソールの**Instance**タブで**オブジェクトストレージにあるバックアップで復元**ボタンをクリックします。
* バックアップファイルが保存されたオブジェクトストレージの情報およびDBインスタンスの情報を入力した後、**作成**ボタンをクリックします。

> [注意]オブジェクトストレージのバックアップファイルと、復元しようとするRDS for MySQLのバージョン은 동일する必要があります。
